...
void load()
{
    ...
    while (i < nb_max_input_raw)
    {
        ...
        for (int m=0; m<haut; m++)
        {
            ...
            {
                if(tab_piece_all[nb_max_input-1].grille[p][m].couleur != 10)// Ici, on n'a plus 8 et 1 mais un certain chiffre ou 10 pour le vide
                {
                    test_vide_ligne = 0;
                }
            }
        ...
        for (int m=0; m<larg; m++)
        {
            ...
            {
                if(tab_piece_all[nb_max_input-1].grille[m][p].couleur != 10)// Ici, on n'a plus 8 et 1 mais un certain chiffre ou 10 pour le vide
                {
                    test_vide_col = 0;
                }
            }
